...
The options page presents those tables as a Rate Book. Current publish storage is browser-local extension storage. Legacy CSV storage is still parsed so older test data and early installs can migrate forward.
